...
export const program: ProgramItem[] = [
  ...
  { time: "12:00 – 12:45 PM", activity: "Church Photography", details: "B&G + Priest; Best Couple; Bridal Team; Parents; Family; Choir", category: "church" },
  { time: "1:00 PM", activity: "Departure to Reception", details: "Bridal team / Bride & Groom → Urafiki Carovana School", category: "church" },
  { time: "1:30 PM", activity: "Reception Begins", details: "Urafiki Carovana School — Guests seated; lunch served", category: "reception" },
  { time: "2:30 PM", activity: "Photo Session", details: "Bridal team / Bride & Groom; photography team", category: "reception" },
  { time: "3:00 PM", activity: "Bridal Entertainment", details: "MC / Bridal team performances", category: "reception" },
